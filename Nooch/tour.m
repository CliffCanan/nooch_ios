...
- (void)showIntroWithCrossDissolve
{
    ...
    page5.bgImage = [UIImage imageNamed:@"bg3"];
    ...
    page6.bgImage = [UIImage imageNamed:@"bg4"];
    page6.titleIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"title4"]];
    
    EAIntroView *intro = [[EAIntroView alloc] initWithFrame:[[UIScreen mainScreen] bounds] andPages:@[page1,page2,page3,page4, page5,page6]];
